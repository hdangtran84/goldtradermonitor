...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'Daily Trading Tips - Gold Dashboard',
    description: 'Realtime Gold (XAU/USD) price chart, AI brief, economic indicators, news, and prediction markets for Gold trading. Live 24/7 by @dtradingtips.',
    keywords: 'gold trading, gold price, XAUUSD, XAU/USD, precious metals, gold market, commodities, gold futures, trading dashboard, economic indicators, gold investment, gold news, gold analysis, daily trading tips',
    url: 'https://goldtradermonitor.vercel.app/',
    siteName: 'Daily Trading Tips',
    shortName: 'GoldDashboard',
    subject: 'Gold Trading, XAU/USD, and Market Intelligence',
    classification: 'Gold Trading Dashboard, Daily Trading Tips',
    categories: ['finance', 'trading'],
    features: [
      'Real-time gold prices',
      'AI-powered market insights',
      'Economic indicator alerts',
      'Gold news aggregation',
      'Prediction markets',
...
function sebufApiPlugin(): Plugin {
  ...
  async function buildRouter() {
    // Gold Trader variant: Only finance-related services
    const [

...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const PANEL_SPANS_KEY = 'goldtrader-panel-spans';
    ...
    const storedVariant = localStorage.getItem('goldtrader-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      localStorage.setItem('goldtrader-variant', currentVariant);
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'goldtrader-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'goldtrader-tech-insights-top-v1';

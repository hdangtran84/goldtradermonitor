...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Daily Trading Tips Gold Dashboard - Gold trading intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - Gold Trader`)}`,
